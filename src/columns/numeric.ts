...
export class SpannerNumericString extends SpannerColumn<ColumnBaseConfig<'string numeric'>> {
...
export class SpannerNumericNumber extends SpannerColumn<ColumnBaseConfig<'number double'>> {
...
export function numeric(name: string, config: SpannerNumericConfig<'string'>): SpannerNumericStringBuilder;
export function numeric(name: string, config: SpannerNumericConfig<'number'>): SpannerNumericNumberBuilder;
