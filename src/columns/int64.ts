...
export interface SpannerInt64Config<
  TMode extends 'number' | 'bigint' = 'number' | 'bigint'
> {
  mode: TMode
}
...
export class SpannerInt64Number extends SpannerColumn<
  ColumnBaseConfig<'number int53'>
> {
...
export class SpannerInt64BigInt extends SpannerColumn<
  ColumnBaseConfig<'bigint int64'>
> {
...
export function int64(
  name: string,
  config: SpannerInt64Config<'number'>
): SpannerInt64NumberBuilder
export function int64(
  name: string,
  config: SpannerInt64Config<'bigint'>
