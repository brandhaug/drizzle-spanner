...
export function date(name: string, config: SpannerDateConfig<'string'>): SpannerDateStringBuilder;
export function date(name: string, config: SpannerDateConfig<'date'>): SpannerDateDateBuilder;
