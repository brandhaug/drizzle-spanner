...
export const ExtraConfigColumns: unique symbol = Symbol.for('drizzle:ExtraConfigColumns');
export const ExtraConfigBuilder: unique symbol = Symbol.for('drizzle:ExtraConfigBuilder');
